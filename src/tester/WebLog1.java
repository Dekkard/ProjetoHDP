...
public class WebLog1 {
	...
	public WebLog1(String line, String regw, String regu) {
		Matcher mat = Pattern.compile(REGEX_IP).matcher(line);
		if(mat.find()) this.ip = mat.group(1);
		mat = Pattern.compile(REGEX_DATE).matcher(line);
		if(mat.find()) this.date = mat.group(1);
		mat = Pattern.compile(REGEX_TIME).matcher(line);
		if(mat.find()) this.time = mat.group(1);
		mat = Pattern.compile(REGEX_GMT).matcher(line);
		if(mat.find()) this.gmt = mat.group(1);
		...
		if(mat.find()) this.protocol = mat.group(1);
